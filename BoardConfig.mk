...
BOARD_BLUEDROID_VENDOR_CONF := device/lge/d858/configs/vnd_g3.conf
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/d858/bluetooth
...
# Kernel
TARGET_KERNEL_CONFIG := cyanogenmod_d858_defconfig
...
# Recovery
TARGET_RECOVERY_FSTAB := device/lge/d858/rootdir/etc/fstab.g3
